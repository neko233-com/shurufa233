...
- CLI candidate actions for preview paging, selection, first/last-character commit, pinyin separator previews, Rime-style user phrases, emoji/symbol catalog lookup, and agent workflows
