...
- CLI candidate actions for preview paging, selection, candidate hiding, first/last-character commit, schema switching, pinyin separator previews, post-commit association candidates, Rime-style reverse lookup, user phrases, emoji/symbol catalog lookup, and agent workflows
