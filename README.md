...
- CLI candidate actions for preview paging, selection, candidate pinning/hiding, first/last-character commit, schema switching, app-context behavior checks, pinyin separator previews, post-commit association candidates, Rime-style reverse lookup, user phrases, emoji/symbol catalog lookup, and agent workflows
