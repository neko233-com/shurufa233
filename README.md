...
- CLI candidate actions for preview paging, selection, candidate hiding, first/last-character commit, pinyin separator previews, post-commit association candidates, Rime-style user phrases, emoji/symbol catalog lookup, and agent workflows
